...
import latihan.latihanpws.exceptions.NonexistentEntityException;
import latihan.latihanpws.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("latihan_latihanpws_jar_0.0.1-SNAPSHOTPU");
